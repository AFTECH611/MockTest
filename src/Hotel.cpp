...
void Hotel::setAddress(std::string _address) {
	address = _address;
}

void Hotel::setName(std::string _name) {
	name = _name;
}
...
void Hotel::display() {
	std::cout << "|" << std::setw(15) << std::left << name << "|"
		...
		<< std::setw(12) << std::left << numbOfTypeRoom << "|"
		<< std::setw(13) << std::left << getMinPrice() << "|" << std::endl;
}
