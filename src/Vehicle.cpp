...
void Vehicle::setStartDate(std::string date){
	startDate = date;	
}

void Vehicle::setEndDate(std::string date){
	endDate = date;
};
void Vehicle::setType(std::string _type){
	type = _type;
};
void Vehicle::setBrand(std::string _brand){
	brand = _brand;
};
void Vehicle::setDeparture(std::string _departure){
	departure = _departure;
};
void Vehicle::setDestination(std::string _destination){
	destination = _destination;
};

void Vehicle::setPrice(int _price){
	price = _price;
};
